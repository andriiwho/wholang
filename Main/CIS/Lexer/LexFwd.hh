...
WHO_TOKEN_VALUE(KWD_IF, "if")
WHO_TOKEN_VALUE(KWD_ELSE, "else")
WHO_TOKEN_VALUE(KWD_FINALLY, "finally")
WHO_TOKEN_VALUE(KWD_FOR, "for")
WHO_TOKEN_VALUE(KWD_FOREACH, "foreach")
WHO_TOKEN_VALUE(KWD_WHILE, "while")
WHO_TOKEN_VALUE(KWD_DO, "do")
WHO_TOKEN_VALUE(KWD_TRUE, "true")
WHO_TOKEN_VALUE(KWD_FALSE, "false")
WHO_TOKEN_VALUE(KWD_RANGE, "range")
WHO_TOKEN_VALUE(KWD_IN, "in")
WHO_TOKEN_VALUE(KWD_BREAK, "break")
WHO_TOKEN_VALUE(KWD_CONTINUE, "continue")
WHO_TOKEN_VALUE(KWD_STRING, "string")
...
WHO_TOKEN_VALUE(INCREMENT, "++")
WHO_TOKEN_VALUE(DECREMENT, "--")
